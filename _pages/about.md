...
<div class="news-box">
  <ul class="news-list">
<li><span class="news-date"><span style="color:inherit">2025.11-present</span></span> <span style="color:#D8BFD8">Development of mixed-flow/axial-flow turbine data post-processing system</span></li>
<li><span class="news-date"><span style="color:inherit">2025.10-2026.05</span></span> <span style="color:#D8BFD8">High-fidelity 3D reconstruction and surface mesh extraction method based on Gaussian splatting and wheeled robots</span></li>
<li><span class="news-date"><span style="color:inherit">2025.03-2025.05</span></span> <span style="color:#D8BFD8">Research and development of visible camera dynamic communication technology for autonomous vehicles</span></li>
<li><span class="news-date"><span style="color:inherit">2024.10-2025.06</span></span> <span style="color:#D8BFD8">Development and online application of large-scale multi-dimensional intelligent flexible inspection system</span></li>
<li><span class="news-date"><span style="color:inherit">2024.10-2024.12</span></span> <span style="color:#D8BFD8">Research on key technologies for joint multi-satellite large-area coverage imaging</span></li>
<li><span class="news-date"><span style="color:inherit">2024.04-2024.06</span></span> <span style="color:#D8BFD8">Research on key technology of commercial vehicle decarbonization based on intelligent cylinder stopping regulation mechanism</span></li>
<li><span class="news-date"><span style="color:inherit">2023.06-2025.04</span></span> <span style="color:#D8BFD8">Development of an experimental demonstration instrument based on Kirchhoff's law of thermal radiation</span></li>
<li><span class="news-date"><span style="color:inherit">2023.04-2023.06</span></span> <span style="color:#D8BFD8">Statistical inference for non-smooth and high-frequency time series models</span></li>
  </ul>
</div>
...
<li>Gated Hierarchical Reinforcement Learning Control for Autonomous Multi-Mode Switching in Mode-Locked Fiber Lasers. <span style="color:#D8BFD8"><i><b>Optics and Laser Technology</b></i></span>, submitted. (JCR Q1, 2nd Author)</li>
<li>Lane‑traversal path planning on structured roads via geometry‑guided pruning and hierarchical divide‑and‑conquer optimization. <span style="color:#D8BFD8"><i><b>Eng. Res. Express</b></i></span>, 2026, 8: 115211. (JCR Q2, 1st Author)</li>
<li>Dual-domain collaborative vision framework for high-fidelity defect detection: integrating line structured light with adaptive 2D/3D fusion. <span style="color:#D8BFD8"><i><b>Journal of Modern Optics</b></i></span>, submitted. (JCR Q4, 1st Author)</li>
<li>A hybrid framework for dynamic optimization of racing car braking system based on BiLSTM and GBDT. <span style="color:#D8BFD8"><i><b>Proc. 2025 IEEE 3rd Int. Conf. Image Process. Comput. Appl. (ICIPCA)</b></i></span>, 2025, pp. 2156-2160. (EI Conference, 1st Author)</li>
</ul>

📚 Patents
<ul class="news-list">
<li>Multimodal Point Cloud 3D Reconstruction and Precision Inspection Software</li>
<li>BiLSTM-GBDT-based Brake Force Co-regulation Software for Intelligent Vehicles</li>
<li>Intelligent Vehicle Multi-Sensor Fusion Monitoring Software Based on 51 Microcontroller</li>
<li>Planetary Optimization Algorithm Based Image Filtering Software for Star Sensors</li>
<li>Precision Attitude Adjustment Control Software Based on Kalman Filter</li>
</ul>
